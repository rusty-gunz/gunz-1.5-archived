...
//				pCommand->GetParameter(szProposerCharName,	1, MPT_STR);
		...
		case MC_MATCH_INFORMATION_RECEIVE:
		{
			...
			{
				MTD_Info* pNode = (MTD_Info*)MGetBlobArrayElement(pBlob, i);
				...
				// Not working yet
				//GetUserGradeIDColor(MMatchUserGradeID(pNode->nGrade), c, NULL);
				//NameLabel->SetTextColor(c);


				ClanLabel->SetText(pNode->szClan);
				char szLevel[128], szBounty[128], szKill[128], szDeath[128], szEXP[128];
