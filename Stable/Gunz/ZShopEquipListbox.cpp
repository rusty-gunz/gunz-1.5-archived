...
// ============ ZShopPurchaseLadderItemListBoxListener ===============================================

class ZShopPurchaseLadderItemListBoxListener : public MListener{
public:
	virtual bool OnCommand(MWidget* pWidget, const char* szMessage)
	{
		if(MWidget::IsMsg(szMessage, MLB_ITEM_SEL) == true)
...
ZShopPurchaseLadderItemListBoxListener g_ShopPurchaseLadderItemListBoxListener;

MListener* ZGetShopPurchaseLadderItemListBoxListener(void)
{
	return &g_ShopPurchaseLadderItemListBoxListener;
}
...
public:
	virtual bool OnCommand(MWidget* pWidget, const char* szMessage)
	{
		if(MWidget::IsMsg(szMessage, MCMBBOX_CHANGED)==true)
		{
			...
			MComboBox* pComboBox = (MComboBox*)pResource->FindWidget("Shop_SubEquipmentFilter");
			if ( pComboBox)
			{
				int sel = pComboBox->GetSelIndex();
...
class MEquipListSubFilterListener : public MListener {
public:
	virtual bool OnCommand(MWidget* pWidget, const char* szMessage)
	{
		if(MWidget::IsMsg(szMessage, MCMBBOX_CHANGED)==true) {
			...
			MComboBox* pComboBox = (MComboBox*)pResource->FindWidget("Equip_SubEquipmentFilter");
			if ( pComboBox)
			{
				int sel = pComboBox->GetSelIndex();
...
MEquipListSubFilterListener g_EquipListSubFilterListener;
