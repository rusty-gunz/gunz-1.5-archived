...
enum {
	zequip_item_subfilter_all = 0,

	zequip_item_subfilter_dagger,
	zequip_item_subfilter_sword,
	zequip_item_subfilter_kodachi,
	zequip_item_subfilter_giant,


	zequip_item_subfilter_breaker,
	zequip_item_subfilter_revs,
	zequip_item_subfilter_pistols,
	zequip_item_subfilter_rifle,
	zequip_item_subfilter_machineg,
	zequip_item_subfilter_smg,
	zequip_item_subfilter_bazooka,
	zequip_item_subfilter_sniper,

	zequip_item_subfilter_pouch,
	zequip_item_subfilter_hp,
	zequip_item_subfilter_ap,
	zequip_item_subfilter_potion,
	zequip_item_subfilter_grenade,
};
...
ZMyItemList::ZMyItemList() : m_bCreated(false)
{
	...
	m_ListSubFilter = zequip_item_subfilter_all;
}
...
{
	if (m_ListSubFilter == zequip_item_subfilter_all)		return true;
	else if (m_ListSubFilter == zequip_item_subfilter_dagger)	{ if(type == MWT_DAGGER || type == MWT_DUAL_DAGGER)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_sword)	{ if(type == MWT_KATANA)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_kodachi)	{ if(type == MWT_DOUBLE_KATANA)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_giant)	{ if(type == MWT_GREAT_SWORD)	return true; }

	else if (m_ListSubFilter == zequip_item_subfilter_breaker)	{ if(type == MWT_SHOTGUN || type == MWT_SAWED_SHOTGUN)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_revs)		{ if(type == MWT_REVOLVER || type == MWT_REVOLVERx2)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_pistols)	{ if(type == MWT_PISTOL || type == MWT_PISTOLx2)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_rifle)	{ if(type == MWT_RIFLE)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_machineg) { if(type == MWT_MACHINEGUN)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_smg)		{ if(type == MWT_SMG || type == MWT_SMGx2)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_bazooka)	{ if(type == MWT_ROCKET)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_sniper)	{ if(type == MWT_SNIFER)	return true; }


	else if (m_ListSubFilter == zequip_item_subfilter_pouch) { if(type == MWT_BULLET_KIT)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_hp)		{ if(type == MWT_MED_KIT)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_ap)	{ if(type == MWT_REPAIR_KIT)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_potion)	{ if(type == MWT_POTION)	return true; }
	else if (m_ListSubFilter == zequip_item_subfilter_grenade)	{ if(type == MWT_FLASH_BANG || type == MWT_FRAGMENTATION || type == MWT_SMOKE_GRENADE || type == MWT_DYNAMITYE)	return true; }
...
{
	if ( m_ListFilter != zequip_item_filter_quest ) return;
...
{
	if ( m_ListFilter != zequip_item_filter_gamble && m_ListFilter != zequip_item_filter_all ) return;
