...
private:
	...
	*/
	...
	ZScreenEffect*  m_pInfectionPanel;
...
public:
	...
	//Custom: Infection
	void AddInfectedWin()		{   AddScreenEffect("infectedWin"); }
	void AddSurvivorsWin()		{	AddScreenEffect("survivorsWin"); }

	void AddRoundResult(MMATCH_GAMETYPE gameType, MMATCH_ROUNDRESULT roundResult);
